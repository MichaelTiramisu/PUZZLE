...
class SendViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let email = userDefault.string(forKey: "sendEmail") {
...
//                    self.statusTextView.text = NSLocalizedString("USER_INFO_LOAD_SUCCESS", comment: "")
                    self.statusTextView.text = NSLocalizedString("", comment: "")
...
//                        self.statusTextView.text = NSLocalizedString("GET_PICTURE_FAILURE", comment: "Picture data is invalid")
                        self.statusTextView.text = NSLocalizedString("", comment: "Picture data is invalid")
                    })
                }
            }
    }
    ...
    func createSampleMessage(to emailAddress: String, picLink pictureUrl: String) -> MSGraphMessage? {
        ...
        message.subject = NSLocalizedString("This is an email sent using PUZZLE", comment: "")
        let messageBody = MSGraphItemBody()
        
        messageBody.contentType = MSGraphBodyType.text()
        messageBody.content = statusTextView.text
